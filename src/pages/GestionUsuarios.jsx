  ...
  return (
    <body className="flex">
      <div className="self-center   container p-20 ml-20 mr-20 mt-10 w-full ">
        ...
        <form onSubmit={submitformulario} ref={form} id="formUsuarios">
          <div className="detalles-producto">
            ...
            <div className="input-box">
              ...
              <select className="border-2" name="rol" required defaultValue={0}>
                <option disabled value={0}>
                  Seleccione un rol
                </option>
                <option value="Administrador" name="rol">
                  {" "}
                  Administrador{" "}
                </option>
                <option value="Vendedor" name="rol">
                  {" "}
                  Vendedor{" "}
                </option>
              </select>
            ...
            <div className="input-box">
              ...
              >
                ...
                <option value="autorizado" name="estado">
                  {" "}
                  Autorizado{" "}
                </option>
                <option value="pendiente" name="estado">
                  {" "}
                  Pendiente{" "}
                </option>
                <option value="no autorizado" name="estado">
                  {" "}
                  No Autorizado{" "}
                </option>
              </select>
