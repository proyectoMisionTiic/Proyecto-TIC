      ...
      <div>
         ...
         <form   action="#">
                      ...
                      <div className='text-3xl mb-10 m-auto text-center '>Ingreso De Productos</div>
                        ...
                        <div className="andrew-button w-full">
                          <input   onClick={mostrarMensajeP} type="submit" value="Ingresar Producto" />
                        </div>
        ...
        <form   action="#">
                ...
                <div className="andrew-detalles-producto ">
                  ...
                  <div className='text-3xl mt-10 m-auto text-center mb-10'>Ingreso De Venta</div>
                  ...
                  <div className="andrew-button w-full ">
                    <input onClick={mostrarMensajeV} type="submit" value="Registrar Venta" />
                  </div>
