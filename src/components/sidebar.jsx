...
const Sidebar = () => {
    ...
    return (
        ...
        <div> 
                ...
                <nav className=' celular:bg-gray-800   prueba flex flex-col celular:w-screen   tablet:h-screen  portatil:h-scrree portatil:w-full tablet:w-full portatil:mr-10 tablet:gap-20 portatil:text-3xl  '>
                ...
                <ul>
                    ...
                    <div className=' flex  hover:bg-green-500 my-1 p-2.5  ml-2 mr-2 tablet:mb-10 portatil:mb-15'>
                        ...
                        <Botonsidebar className='celular:' NombreBoton='Gestionar Usuarios' />
                    </div>
